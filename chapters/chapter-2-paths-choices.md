...
This chapter focuses on **decision-making under uncertainty**, implemented through the *Information Clarification and Alignment* capability of The Fellowship Companion.

At this stage of the project, the system addresses a critical challenge: ensuring that the Fellowship does not act on unclear, conflicting, or misunderstood information. Instead of increasing information flow, the system structures how ambiguity is identified, shared, and resolved.

This chapter demonstrates how ambiguity is transformed into a visible and manageable state, allowing the group to move from uncertainty to aligned action.
